    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div id="inspectionmedStatus" data-chart-size="B"></div>
          </div>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div class="charts-wrapper">
              <div id="inspectionmedYearly" data-chart-size="B"></div>
            </div>
          </div>
        </div>
      </div>
...
module.exports = {
  ...
  mounted(){
    this.$nextTick(function() {
      //inspection
      axios.get(BASE_URL+'dashboard/med/charts_data/inspection')
      .then(result =>{
        ...
        if (selectedYear === 'ALL') {
          ...
          this.$parent.dougnutYearTypeCharts('Status' ,'inspectionmedStatus' ,statusYear ,statusTotal, statusChild, this.$parent.colorcode.sixColorCondition);
          //By yearly
          ...
          this.$parent.barTypeCharts('inspectionmedYearly' ,monthName ,inspectionYearlySeriesData ,this.$parent.colorcode.twoColorInstallment);
        }else {
