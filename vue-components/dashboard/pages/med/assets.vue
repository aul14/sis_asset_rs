    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div id="assetsmedStatus" data-chart-size="A"></div>
          </div>
        </div>
      </div>
      <div class="col-xl-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
              <div id="assetsmedOwnership" data-chart-size="A"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div class="charts-wrapper">
              <div id="assetsmedInvestment" data-chart-size="B"></div>
            </div>
          </div>
        </div>
      </div>
      <div class="col-xl-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div id="assetsmedLifetime" data-chart-size="B"></div>
          </div>
        </div>
      </div>
    </div>
...
module.exports={
  mounted(){
    this.$nextTick(function(){
      ...
      axios.get(BASE_URL+'dashboard/med/charts_data/assets')
      .then(result => {
        ...
        this.$parent.dougnutTypeCharts('Status' ,'assetsmedStatus',conditionTotal, conditionChild, this.$parent.colorcode.fiveColorStatus);
        ...
        this.$parent.dougnutTypeCharts('Ownership By' ,'assetsmedOwnership' ,ownershipTotal, ownershipChild, this.$parent.colorcode.sevenColorStatus);
        ...
        this.$parent.dougnutTypeCharts('Assets Age' ,'assetsmedLifetime' ,lifetimeTotal, lifetimeChild, this.$parent.colorcode.sixColorInformation);
        ...
        if (selectedYear === 'ALL') {
          ...
          this.$parent.barTypeCharts('assetsmedInvestment' ,investYear ,investmentSeriesData ,this.$parent.colorcode.triColorPrice);
        }else {
