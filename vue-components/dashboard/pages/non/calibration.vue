    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div id="calibrationnonStatus" data-chart-size="B"></div>
          </div>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div class="charts-wrapper">
                <div id="calibrationnonYearly" data-chart-size="B"></div>
            </div>
          </div>
        </div>
      </div>
...
module.exports = {
  ...
  mounted(){
    this.$nextTick(function() {
      //Calibration
      axios.get(BASE_URL+'dashboard/non/charts_data/calibration')
      .then(result => {
        ...
        if (selectedYear === 'ALL') {
          ...
          this.$parent.dougnutYearTypeCharts('Status', 'calibrationnonStatus' ,statusYear, statusTotal, statusChild, this.$parent.colorcode.fourColorReverse);
          ...
          this.$parent.barTypeCharts('calibrationnonYearly' ,monthName ,calibrationYearlySeriesData ,this.$parent.colorcode.twoColorInstallment);
        }else {
