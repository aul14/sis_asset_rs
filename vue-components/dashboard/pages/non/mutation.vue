    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div id="mutationnonStatus" data-chart-size="B"></div>
          </div>
        </div>
      </div>
      <div class="col-xl-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div class="charts-wrapper">
              <div id="mutationnonYearly" data-chart-size="B"></div>
            </div>
          </div>
        </div>
      </div>
...
module.exports={
  mounted(){
    this.$nextTick(function() {
      //mutation
      axios.get(BASE_URL+'dashboard/non/charts_data/mutation')
      .then(result =>{
        ...
        if (selectedYear === 'ALL') {
          ...
          mutationByStatus('Status','mutationnonStatus',statusYear, statusTotal, statusChild, this.$parent.colorcode.fourColorReverse);
          //By yearly
          ...
          this.$parent.lineTypeCharts('mutationnonYearly', monthName ,mutationYearlySeriesData ,this.$parent.colorcode.triColorStatus);
        }else {
