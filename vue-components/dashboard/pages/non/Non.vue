...
module.exports={
  ...
  components:{
    'assets':httpVueLoader(BASE_URL+'vue-components/dashboard/pages/non/assets.vue?v=1.4'),
    'calibration':httpVueLoader(BASE_URL+'vue-components/dashboard/pages/non/calibration.vue?v=1.3'),
    'inspection':httpVueLoader(BASE_URL+'vue-components/dashboard/pages/non/inspection.vue?v=1.3'),
    'maintenance':httpVueLoader(BASE_URL+'vue-components/dashboard/pages/non/maintenance.vue?v=1.3'),
    'complain-repair':httpVueLoader(BASE_URL+'vue-components/dashboard/pages/non/complain_repair.vue?v=1.3'),
    'mutation':httpVueLoader(BASE_URL+'vue-components/dashboard/pages/non/mutation.vue?v=1.2')
  },
  methods:{
    monthIndex(m){
  ...
  updated(){
    this.$nextTick(function() {
      ...
      $('.number[no-percent="true"], .number').each(function() {
        if ($(this).text() == "") {
          $(this).text('0');
        }
      })
