  ...
  <section>
      ...
      <div class="card with-shadow is-soft-rounded">
        ...
        <div class="card-body">
          <div class="charts-wrapper-lg">
            <div id="complanrepairnonYearly" data-chart-size="B"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-12">
      <div class="card with-shadow is-soft-rounded">
        ...
        <div class="card-body">
            <div class="charts-wrapper-lg">
              <div id="complainrepairnonrepairResponseTime" data-chart-size="B"></div>
            </div>
...
module.exports = {
  ...
  mounted(){
    this.$nextTick(function() {
      axios.get(BASE_URL+'dashboard/non/charts_data/complain_repair')
      .then(result=>{
        ...
        if (selectedYear === 'ALL') {
          ...
          this.$parent.lineTypeCharts('complanrepairnonYearly',monthName ,complainYearlySeriesData , this.$parent.colorcode.twoColorStatus);
        ...
        this.$parent.dougnutYearTypeCharts('Status','repairByPIC' ,yearsName.name, personTotal, personChild, this.$parent.colorcode.triColorPerson);
          ...
          this.$parent.barTypeCharts('complainrepairnonrepairResponseTime' ,repairData.yearData ,repairResponseSeriesData ,this.$parent.colorcode.sixteenColorInformation);
        }else {
