    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div id="assetsbldStatus" data-chart-size="A"></div>
          </div>
        </div>
      </div>
      <div class="col-xl-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
              <div id="assetsbldOwnership" data-chart-size="A"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div class="charts-wrapper-lg">
              <div id="assetsbldInvestment" data-chart-size="B"></div>
            </div>
          </div>
        </div>
      </div>
      <div class="col-xl-6">
        <div class="card with-shadow is-soft-rounded">
          ...
          <div class="card-body">
            <div id="assetsbldLifetime" data-chart-size="B"></div>
          </div>
        </div>
      </div>
    </div>
...
module.exports={
  mounted(){
    this.$nextTick(function(){
      ...
      axios.get(BASE_URL+'dashboard/building/charts_data/assets')
      .then(result => {
        ...
        this.$parent.dougnutTypeCharts('Status' ,'assetsbldStatus',conditionTotal, conditionChild, this.$parent.colorcode.fiveColorStatus);
        ...
        this.$parent.dougnutTypeCharts('Ownership By' ,'assetsbldOwnership' ,ownershipTotal, ownershipChild, this.$parent.colorcode.sevenColorStatus);
        ...
        this.$parent.dougnutTypeCharts('Assets Age' ,'assetsbldLifetime' ,lifetimeTotal, lifetimeChild, this.$parent.colorcode.sixColorInformation);
        ...
        if (selectedYear === 'ALL') {
          ...
          this.$parent.barTypeCharts('assetsbldInvestment' ,investYear ,investmentSeriesData ,this.$parent.colorcode.triColorPrice);
        }else {
