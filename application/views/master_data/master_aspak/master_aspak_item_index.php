<main dir="ltr" class="page-wrapper full-height" id="App">
  <main-app>
    <action-button-card title="Master Data - Master ASPAK - Master Aspak Item">
...
<script>
  function TableData() {
    let table = $('.samrs-table1').DataTable({
      ...
      "ajax": {
        "url": BASE_URL + "master_data/master_aspak/master_aspak_items/data_table",
        "dataType": "json",
        "data": {},
        "type": "POST",
        "cache": true,
      ...
      columns: [{
        ...
        {
          title: 'Aspak Item Code',
          name: 'Aspak Item Code',
          data: 'aspakItemCode'
        },
        {
          title: 'Aspak Item Name',
          name: 'Aspak Item Name',
          data: 'aspakItemName'
        },
      ],
