<div id="taskcategory_form" class="modal samrs-modal zoom fade" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('master_data/task_category/store'); ?>" method="post" id="addform">
            <div class="modal-content">
                <div class="modal-header">
                    <p id="title-task-category">add new task category</p>
                ...
                <div class="modal-body fixed-height samrs-form" id="app_form">
                    <form-taskcategory></form-taskcategory>
                </div>
                <div class="modal-footer">
                    ...
                    <a class="btn samrs-danger is-outline" href="<?= base_url('master_data/task_category'); ?>">Cancel</a>
                </div>
            </div>
        </form>
    </div>
                        ...
                        if (response.queryResult == true) {
                            if (!is_close) {
                                ...
                                Swal.fire({
                                    ...
                                    $('.samrs-table1').DataTable().ajax.reload();
                                    document.location.href = "<?php echo base_url(); ?>master_data/task_category";
                                });
