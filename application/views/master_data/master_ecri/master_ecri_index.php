<main dir="ltr" class="page-wrapper full-height" id="App">
  <main-app>
    <action-button-card title="Master Data - Master ECRI">
...
<script>
  function TableData() {
    let table = $('.samrs-table1').DataTable({
      ...
      "ajax": {
        "url": BASE_URL + "master_data/master_ecri/data_table",
        "dataType": "json",
        "data": {},
        "type": "POST",
        "cache": true,
      ...
      columns: [{
        ...
        {
          title: 'Ecri Parent Code',
          name: 'Ecri Parent Code',
          data: 'ecriParentCode'
        },
        {
          title: 'Ecri Name',
