...
header("Content-Disposition: attachment; filename=report_room_inventory.xls");
            ...
            <table border="1" width="50%">
                <thead>
                    <tr>
                        ...
                        <th align="center">ELECTRICAL POWER</th>
                ...
                <tbody>
                    ...
                    foreach ($assets['data'] as $asset) { ?>
                        <tr>
                            <td align="center" style="width:70px !important"><?php echo $no++; ?></td>
                            <td align="justify"><?php echo $asset['roomCode']; ?></td>
                            <td align="justify"><?php echo $asset['roomName']; ?></td>
                            <td align="justify"><?php echo $asset['floorName']; ?></td>
                            <td align="justify"><?php echo $asset['buildingName']; ?></td>
                            <td align="justify"><?php echo $asset['roomSpace'] . ' ' . $asset['spaceUnit']; ?></td>
                            <td align="justify"><?php echo $asset['bedCount']; ?></td>
                            <td align="justify"><?php echo $asset['roomPower'] . ' ' . $asset['powerUnit']; ?></td>


                            <!-- <td align="justify"><?php echo $asset['createDate']; ?></td> -->
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
