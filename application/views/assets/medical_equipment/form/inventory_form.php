<div id="inventory_form" class="modal samrs-modal zoom fade" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <form id="inventory-form">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn samrs-danger is-outline" href="<?= base_url('asset/me/inventory_me'); ?>">Cancel</a>
        </div>
      </div>
    </form>
  </div>
...
<script>
  $(function() {
    ...
    $('#inventory-form').submit(function(e) {
      e.preventDefault();
      $.ajax({
        url: BASE_URL + 'asset/me/inventory_me/store',
        type: "POST",
          ...
          if (response.queryResult == true) {
            if (!is_close) {
              ...
              Swal.fire({
                ...
                $('.samrs-table1').DataTable().ajax.reload();
                document.location.href = "<?php echo base_url(); ?>asset/me/inventory_me";
              });
