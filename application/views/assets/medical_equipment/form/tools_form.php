<div id="tools_form" class="modal samrs-modal zoom fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <form id="tools-form">
      <div class="modal-content">
        <div class="modal-header">
          <p id="title-asset">Add New Asset</p>
        ...
        <div class="modal-body fixed-height samrs-form" id="app_form">
          ...
          <input name="subSysCat" id="subSysCat" type="hidden" value="TOOLS">
          <main-form>
        ...
        <div class="modal-footer">
          ...
          <a class="btn samrs-danger is-outline" href="<?= base_url('asset/me/tools_med'); ?>">Cancel</a>
        </div>
      </div>
    </form>
  </div>
...
<script>
  $(function() {
    ...
    $('#tools-form').submit(function(e) {
      e.preventDefault();
      $.ajax({
        url: BASE_URL + 'asset/me/tools_med/store',
        type: "POST",
          ...
          if (response.queryResult == true) {
            if (!is_close) {
              ...
              Swal.fire({
                ...
                $('.samrs-table1').DataTable().ajax.reload();
                document.location.href = "<?php echo base_url(); ?>asset/me/tools_med";
              });
