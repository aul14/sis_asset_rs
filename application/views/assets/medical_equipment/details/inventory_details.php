        ...
        <div class="col-xl-9 pr-1">
          <div class="samrs-tab blue">
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item" id="tab-stock-detail" style="display: none;">
                <a class="nav-link" href="#stock_details" data-toggle="tab">stock</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content fixed-height">
              ...
              <div class="tab-pane fade" role="tabpanel" id="stock_details">
                <detail-stock></detail-stock>
              </div>
