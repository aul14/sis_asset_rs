...
header("Content-Disposition: attachment; filename=report_summary_non_equipment.xls");
    ...
    <div class="book">
        <div class="page">
            <div style="text-align: center;">
                <h1>REPORT SUMMARY NON MEDICAL EQUIPMENT <?= strtoupper($this->session->userdata('hospital')); ?></h1>
            </div>
            <br>
