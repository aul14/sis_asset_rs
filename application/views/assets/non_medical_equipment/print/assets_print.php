<form id="signature" action="<?= base_url('asset/non/inventory_non/report/'); ?>" target="_blank" method="POST">
                ...
                <tr>
                  ...
                  <td>
                    <label class="p-0 float-right">
                      <input class="samrs-switch" type="checkbox" name="jenis" data-toggle="toggle" data-size="small" data-on="Yes" data-off="No" data-onstyle="success" data-offstyle="danger" value="summary">
                    </label>
                  </td>
                </tr>
              </tbody>
