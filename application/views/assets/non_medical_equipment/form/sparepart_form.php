    ...
    <form id="ajax-stock-form">
      <div class="modal-content">
        <div class="modal-header">
          <p id="title-asset">add new non medical equipment sparepart and disposable</p>
          <a href="<?= base_url('asset/non/sparepart_non'); ?>" class="btn btn-rounded btn-outline-danger" type="button" class="close" aria-hidden="true">×</a>
        </div>
          ...
          <div class="samrs-tab red" id="ajax_page_tab" style="display: none;">
            <ul class="nav nav-tabs" role="tablist" id="ajax_tab_ul">
              ...
              <li class="nav-item" role="presentation" id="ajax_tab_li_code" style="display: none;">
                <a class="nav-link modal-code-parts" href="#code" data-toggle="tab" role="tab">code</a>
              </li>
              ...
              <li class="nav-item" role="presentation" id="ajax_tab_li_file" style="display: none;">
                <a class="nav-link modal-file-parts" href="#file" data-toggle="tab" role="tab">file</a>
              </li>
              ...
              <li class="nav-item" role="presentation" id="ajax_tab_li_depre2" style="display: none;">
                <a class="nav-link modal-depre2-parts" href="#depreciation_2" data-toggle="tab" role="tab">depreciation 2</a>
              </li>
                  ...
                  <div class="row">
                    <div class="col-xl-6">
                      <div class="form-group row name-parts" style="display: none;">
                        ...
                        <div class="col-8">
                          <input class="form-control" type="text" readonly id="ajax_assetname_stock">
                        </div>
                      </div>
        ...
        <div class="modal-footer">
          ...
          <a class="btn samrs-danger is-outline" href="<?= base_url('asset/non/sparepart_non'); ?>">Cancel</a>
        </div>
      </div>
    </form>
  </div>
...
<script>
  ...
  $(function() {
    ...
    $('#ajax-stock-form').submit(function(e) {
      e.preventDefault();
      $.ajax({
        url: BASE_URL + 'asset/non/sparepart_non/store',
        type: "POST",
          ...
          if (response.queryResult == true) {
            if (!is_close) {
              ...
              Swal.fire({
                ...
                $('.samrs-table1').DataTable().ajax.reload();
                document.location.href = "<?php echo base_url(); ?>asset/non/sparepart_non";
              });
  ...
  function onChangeMasterAsset() {
    $('.with-ajax-masterAsset').change(function(e) {
      ...
      if (idAssetMaster != undefined) {
        $.ajax({
          type: "post",
          url: BASE_URL + "asset/non/sparepart_non/ajax_asset_master_by_id",
          data: {
  ...
  function calcDepre1() {
    ...
    $.ajax({
      type: 'post',
      url: BASE_URL + 'asset/non/sparepart_non/calc_depre',
      data: values,
  ...
  function evtSelectFileCat(evt) {
    var options = {
      ajax: {
        ...
        emptyRequest: true,
        url: BASE_URL + "asset/non/sparepart_non/ajax_file_cat",
        type: 'POST',
        dataType: 'json',
  ...
  function evtMasterAssetInstrument(evt) {
    var options = {
      ajax: {
        // url     : SITE_URL + "assets/vendors/bootstrap-select-ajax/example/php/ajax.php",
        emptyRequest: true,
        url: BASE_URL + "asset/non/sparepart_non/ajax_asset_master_instrument",
        type: 'POST',
        dataType: 'json',
        // Use "{{{q}}}" as a placeholder and Ajax Bootstrap Select will
        // automatically replace it with the value of the search query.
  ...
  function evtBrandMasterInstrument(evt) {
    var options = {
      ajax: {
        // url     : SITE_URL + "assets/vendors/bootstrap-select-ajax/example/php/ajax.php",
        emptyRequest: true,
        url: BASE_URL + "asset/non/sparepart_non/ajax_brand",
        type: 'POST',
        dataType: 'json',
        // Use "{{{q}}}" as a placeholder and Ajax Bootstrap Select will
        // automatically replace it with the value of the search query.
