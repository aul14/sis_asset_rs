<main dir="ltr" class="page-wrapper full-height" id="App">
  <main-app>
    ...
    <action-button-card title="Non Medical Equipment - Tools & Meter">
      <template v-slot:buttons>
        <table-init></table-init>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][2]['subMenu3'][0]['isAllow'] == true) : ?>
          <add-data modal="tools_form"></add-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][2]['subMenu3'][1]['isAllow'] == true) : ?>
          <edit-data button-id="modal_edit_tools"></edit-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][2]['subMenu3'][2]['isAllow'] == true) : ?>
          <delete-data button-id="modal_delete_tools"></delete-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][2]['subMenu3'][3]['isAllow'] == true) : ?>
          <detail-data button-id="modal_detail_tools"></detail-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][2]['subMenu3'][4]['isAllow'] == true) : ?>
          <print-qr-data button-id="modal_qr_tools"></print-qr-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][2]['subMenu3'][5]['isAllow'] == true) : ?>
          <print-data modal="assets_print"></print-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][2]['subMenu3'][6]['isAllow'] == true) : ?>
          <table-advance-search overlay="advanced_search"></table-advance-search>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][2]['subMenu3'][7]['isAllow'] == true) : ?>
          <!-- <table-quick-view></table-quick-view> -->
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][2]['subMenu3'][8]['isAllow'] == true) : ?>
          <table-column-view></table-column-view>
        <?php endif; ?>
      </template>
      <template v-slot:content>
        <form action="<?= base_url('asset/non/tools_non'); ?>" method="get">
...
<script>
  function TableData() {
    ...
    var table = $('.samrs-table1').DataTable({
      ...
      "ajax": {
        "url": BASE_URL + "asset/me/tools_data_table/asset_data_table?vmode=" + "<?= $this->input->get('vmode'); ?>",
        "dataType": "json",
        "data": {
  ...
  function detail() {
    $('#modal_detail_tools').click(function() {
      // e.preventDefault();
      var idAsset = [];
  ...
  function edit() {
    // create function edit
    $('#modal_edit_tools').click(function() {
      // e.preventDefault();
      var idAsset = [];
      // Read all checked checkboxes
      $("input:checkbox[class=delete_check]:checked").each(function() {
  ...
  function hapus() {
    ...
    $('#modal_delete_tools').click(function() {
      // e.preventDefault();
