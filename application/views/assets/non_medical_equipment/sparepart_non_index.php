<main dir="ltr" class="page-wrapper full-height" id="App">
  <main-app>
    ...
    <action-button-card title="Non Medical Equipment - Sparepart & Disposable">
      <template v-slot:buttons>
        <table-init></table-init>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][1]['subMenu3'][0]['isAllow'] == true) : ?>
          <add-data modal="sparepart_form"></add-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][1]['subMenu3'][1]['isAllow'] == true) : ?>
          <edit-data button-id="modal_edit_parts"></edit-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][1]['subMenu3'][2]['isAllow'] == true) : ?>
          <stock-data button-id="modal_stock_parts"></stock-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][1]['subMenu3'][3]['isAllow'] == true) : ?>
          <delete-data button-id="modal_delete_parts"></delete-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][1]['subMenu3'][4]['isAllow'] == true) : ?>
          <detail-data button-id="modal_detail_parts"></detail-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][1]['subMenu3'][5]['isAllow'] == true) : ?>
          <print-qr-data button-id="modal_qr_parts"></print-qr-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][1]['subMenu3'][6]['isAllow'] == true) : ?>
          <print-data modal="assets_print"></print-data>
        <?php endif; ?>
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][1]['subMenu3'][7]['isAllow'] == true) : ?>
          <table-advance-search overlay="advanced_search"></table-advance-search>
        <?php endif; ?>
        <!-- <table-quick-view></table-quick-view> -->
        <?php if ($result_role[1]['subMenu1'][1]['subMenu2'][1]['subMenu3'][8]['isAllow'] == true) : ?>
          <table-column-view></table-column-view>
        <?php endif; ?>
      </template>
      <template v-slot:content>
        <form action="<?= base_url('asset/non/sparepart_non'); ?>" method="get">
