<main dir="ltr" class="page-wrapper full-height" id="App">
  <main-app>
    ...
    <action-button-card title="Electromedic Task - Mutation">
      <template v-slot:buttons>
        <table-init></table-init>
        <?php if ($result_role[2]['subMenu1'][0]['subMenu2'][3]['subMenu3'][0]['isAllow'] == true) : ?>
          <approve-data button-id="modal_approve_mtn"></approve-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][0]['subMenu2'][3]['subMenu3'][1]['isAllow'] == true) : ?>
          <add-data modal="mutation_form"></add-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][0]['subMenu2'][3]['subMenu3'][2]['isAllow'] == true) : ?>
          <delete-data button-id="modal_delete_mtn"></delete-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][0]['subMenu2'][3]['subMenu3'][3]['isAllow'] == true) : ?>
          <return-data button-id="modal_return_mtn"></return-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][0]['subMenu2'][3]['subMenu3'][4]['isAllow'] == true) : ?>
          <confirm-data button-id="modal_confirm_mtn"></confirm-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][0]['subMenu2'][3]['subMenu3'][5]['isAllow'] == true) : ?>
          <table-advance-search overlay="advanced_search"></table-advance-search>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][0]['subMenu2'][3]['subMenu3'][6]['isAllow'] == true) : ?>
    ...
    $("#modal_confirm_mtn").click(function() {
      ...
      if (idTask.length == 1) {
        ...
        if (mutationStatus == 'Returned') {
          ...
          $.ajax({
            type: "POST",
            url: BASE_URL + "task/med/mutation/task_by_id",
            data: {
              'idTask': idTask
            },
            dataType: "json",
