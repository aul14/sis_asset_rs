...
header("Content-Disposition: attachment; filename=report_task_maintenance.xls");
                    ...
                    foreach ($tasks['data'] as $task) { ?>
                        ...
                        <?php foreach ($task['propTaskMaintenance'] as $propTaskMaintenance) { ?>
                            <tr>
                                ...
                                <?php } ?>
                                <td align="justify"><?php echo $propTaskMaintenance['propAsset']['assetCode']; ?></td>
                                <td align="justify"><?php echo $propTaskMaintenance['propAsset']['assetName']; ?></td>
                                <td align="justify"><?php echo $propTaskMaintenance['propAsset']['propAssetPropgenit']['merk'] == "" ? "-" : $propTaskMaintenance['propAsset']['propAssetPropgenit']['merk']; ?></td>
                                <td align="justify"><?php echo $propTaskMaintenance['propAsset']['propAssetPropgenit']['tipe'] == "" ? "-" : $propTaskMaintenance['propAsset']['propAssetPropgenit']['tipe']; ?></td>
                                <td align="justify"><?php echo $propTaskMaintenance['propAsset']['propAssetPropgenit']['serialNumber'] == "" ? "-" : $propTaskMaintenance['propAsset']['propAssetPropgenit']['serialNumber']; ?></td>
                                <td align="justify"><?php echo $propTaskMaintenance['propAsset']['propAssetPropadmin']['propAssetPropbuildingRoom']['roomName'] == "" ? "-" : $propTaskMaintenance['propAsset']['propAssetPropadmin']['propAssetPropbuildingRoom']['roomName']; ?></td>
                                ...
                                <td align="justify"><?php echo $propTaskMaintenance['propForm']['finalResult']; ?></td>
                            </tr>
                        <?php } ?>
                    <?php } ?>
                </tbody>
