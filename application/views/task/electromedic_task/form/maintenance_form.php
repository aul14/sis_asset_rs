    ...
    <form id="mtn-formfirst">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <a href="<?= base_url('task/med/maintenance/schedule_report'); ?>" class="btn btn-rounded btn-outline-danger" class="close" aria-hidden="true">×</a>
        </div>
        ...
        <div class="modal-footer">
          <div class="mr-10 ml-10">
            <button class="btn samrs-primary" type="submit" id="btn-mtn-first" value="save">Save</button>
            <button class="btn samrs-success" type="submit" id="btn-mtn-first" value="save_close">Save & Exit</button>
          </div>
          <a class="btn samrs-danger is-outline" href="<?= base_url('task/med/maintenance/schedule_report'); ?>">Cancel</a>
        </div>
      </div>
    </form>
  </div>
...
<script>
  ...
  $(function() {
    ...
    $('#mtn-formfirst').submit(function(e) {
      e.preventDefault();
      $.ajax({
        url: BASE_URL + 'task/med/maintenance/schedule_report/store',
        type: "POST",
