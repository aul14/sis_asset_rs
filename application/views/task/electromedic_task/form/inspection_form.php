    ...
    <form id="inp-formfirst">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <a class="btn btn-rounded btn-outline-danger" href="<?= base_url('task/med/inspection/schedule_report'); ?>" class="close" aria-hidden="true">×</a>
        </div>
        ...
        <div class="modal-footer">
          ...
          <a class="btn samrs-danger is-outline" href="<?= base_url('task/med/inspection/schedule_report'); ?>">Cancel</a>
        </div>
      </div>
    </form>
  </div>
...
<script>
  ...
  $(function() {
    ...
    $('#inp-formfirst').submit(function(e) {
      e.preventDefault();
      $.ajax({
        url: BASE_URL + 'task/med/inspection/schedule_report/store',
        type: "POST",
