    ...
    <form id="cal-form">
      <div class="modal-content">
        <div class="modal-header">
          <p id="title-calibration">add new calibration</p>
          <a href="<?= base_url('task/med/calibration/schedule_report'); ?>" class="btn btn-rounded btn-outline-danger" class="close" aria-hidden="true">×</a>
        </div>
        ...
        <div class="modal-footer">
          ...
          <a class="btn samrs-danger is-outline" href="<?= base_url('task/med/calibration/schedule_report'); ?>">Cancel</a>
        </div>
      </div>
    </form>
  </div>
...
<div id="task_calibration_form" class="modal samrs-modal zoom fade" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <form action="<?= base_url('task/med/calibration/schedule_report/update_action'); ?>" id="editcalibration">
      <div class="modal-content">
        <div class="modal-header">
          <p>Calibration : </p>
          <a class="btn btn-rounded btn-outline-danger" class="close" href="<?= base_url('task/med/calibration/schedule_report'); ?>" aria-hidden="true">×</a>
        </div>
...
<script>
  ...
  $(function() {
    ...
    $('#cal-form').submit(function(e) {
      e.preventDefault();
      $.ajax({
        url: BASE_URL + 'task/med/calibration/schedule_report/store',
        type: "POST",
