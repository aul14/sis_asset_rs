<div id="maintenance_form_edit" class="modal samrs-modal zoom fade" data-backdrop="static" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <form action="<?= base_url('task/med/maintenance/schedule_report/store_form_edit'); ?>" id="app_form_edit">
      <div class="modal-content">
        <div class="modal-header">
          <p id="title-report-main">report form maintenance</p>
        ...
        <div class="modal-body fixed-height samrs-form" id="template_taskform">
          ...
          <form-main>
            <template v-slot:ftname-form>
              <input class="form-control" name="ftName" type="text" id="ftName" value="Maintenance Forms" required readonly>
            </template>
          </form-main>
          ...
          <subform-result title-result="maintenance"></subform-result>
          <subform-signature>
...
<div id="select_parts" class="modal samrs-modal zoom fade" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <p>select maintenance material</p>
        <button class="btn btn-rounded btn-outline-danger" type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
      </div>
      <div class="modal-body fixed-height samrs-form">
        <div class="table-responsive">
...
<script>
  function printArea() {
    $("#template_taskform").printThis({
      importCSS:true,
      header: "<h2 style='text-align: center;'>Report Form Maintenance</h2>"
    });
  }
  ...
  function clickback() {
    ...
    ?>
    document.location.href = "<?php echo base_url(); ?>task/med/maintenance/schedule_report";
  }
</script>