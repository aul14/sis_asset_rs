...
<main dir="ltr" class="page-wrapper full-height" id="App">
  <main-app>
    <action-button-card title="Non Medic Task - Calibration Schedule Table" with-search="false">
      <template v-slot:buttons>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][0]['subMenu3'][1]['subMenu4'][0]['isAllow'] == true) : ?>
        ...
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][0]['subMenu3'][1]['subMenu4'][1]['isAllow'] == true) : ?>
        ...
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][0]['subMenu3'][1]['subMenu4'][2]['isAllow'] == true) : ?>
          <print-data modal="task_print"></print-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][0]['subMenu3'][1]['subMenu4'][3]['isAllow'] == true) : ?>
