...
<main dir="ltr" class="page-wrapper full-height" id="App">
  <main-app>
    <action-button-card title="Non Electromedic Task - Inspection Schedule Table" with-search="false">
      <template v-slot:buttons>
        <schedule-init></schedule-init>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][1]['subMenu3'][1]['subMenu4'][0]['isAllow'] == true) : ?>
          <previous data-form="getForm" link="<?php echo site_url('task/non/inspection/schedule_table') ?>?years=<?php echo $prev_month_y ?>&month=<?php echo $prev_month_m ?>"></previous>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][1]['subMenu3'][1]['subMenu4'][1]['isAllow'] == true) : ?>
          <next data-form="getForm" link="<?php echo site_url('task/non/inspection/schedule_table') ?>?years=<?php echo $next_month_y ?>&month=<?php echo $next_month_m ?>"></next>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][1]['subMenu3'][1]['subMenu4'][2]['isAllow'] == true) : ?>
          <print-data modal="task_print"></print-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][1]['subMenu3'][1]['subMenu4'][3]['isAllow'] == true) : ?>
