<div id="mutation_approve" class="modal samrs-modal zoom fade" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('task/non/mutation/store_approve'); ?>" id="approveform" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <p>Approval Mutation</p>
                    <a href="<?= base_url('task/non/mutation'); ?>" class="btn btn-rounded btn-outline-danger" class="close" aria-hidden="true">×</a>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn samrs-danger is-outline" href="<?= base_url('task/non/mutation'); ?>">Cancel</a>
                </div>
            </div>
        </form>
    </div>
