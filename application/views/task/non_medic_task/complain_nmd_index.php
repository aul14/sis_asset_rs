<main dir="ltr" class="page-wrapper full-height" id="App">
  <main-app>
    ...
    <action-button-card title="Non Electromedic Task - Complain">
      <template v-slot:buttons>
        <table-init></table-init>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][4]['subMenu3'][0]['isAllow'] == true) : ?>
          <approve-data button-id="modal_approve_repair"></approve-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][4]['subMenu3'][1]['isAllow'] == true) : ?>
          <add-data modal="complain_form"></add-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][4]['subMenu3'][2]['isAllow'] == true) : ?>
          <edit-data button-id="modal_edit_complain"></edit-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][4]['subMenu3'][3]['isAllow'] == true) : ?>
          <delete-data button-id="modal_delete_complain"></delete-data>
        <?php endif; ?>

        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][4]['subMenu3'][4]['isAllow'] == true) : ?>
          <div class="grid-box">
            <a id="modal_detail_repair" data-toggle="modal" class="btn btn-block samrs-info"><i class="fas fa-book-open"></i> Details</a>
          </div>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][4]['subMenu3'][5]['isAllow'] == true) : ?>
          <print-data modal="task_print"></print-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][4]['subMenu3'][6]['isAllow'] == true) : ?>
          <table-advance-search overlay="advanced_search"></table-advance-search>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][4]['subMenu3'][7]['isAllow'] == true) : ?>
...
<script>
  ...
  function shortcut_repair() {
    $(document).on('click', '#shortcut-repair', function() {
      ...
      $.ajax({
        type: "POST",
        url: BASE_URL + "task/non/complain/complain_by_id_no_array",
        data: {
          'idTask': idTask
        },
        dataType: "json",
