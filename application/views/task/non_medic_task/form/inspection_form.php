<div id="inspection_form" class="modal samrs-modal zoom fade" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <form id="inp-formfirst">
      <div class="modal-content">
        <div class="modal-header">
          <p>add new inspection</p>
          <a class="btn btn-rounded btn-outline-danger" href="<?= base_url('task/non/inspection/schedule_report'); ?>" class="close" aria-hidden="true">×</a>
        </div>
        ...
        <div class="modal-footer">
          ...
          <a class="btn samrs-danger is-outline" href="<?= base_url('task/non/inspection/schedule_report'); ?>">Cancel</a>
        </div>
      </div>
    </form>
  </div>
...
<script>
  ...
  $(function() {
    ...
    $('#inp-formfirst').submit(function(e) {
      e.preventDefault();
      $.ajax({
        url: BASE_URL + 'task/non/inspection/schedule_report/store',
        type: "POST",
