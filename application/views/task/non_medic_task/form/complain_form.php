    ...
    <form id="complain-form">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn samrs-danger is-outline" href="<?= base_url('task/non/complain'); ?>">Cancel</a>
        </div>
      </div>
    </form>
  </div>
...
<script>
  $(function() {
    ...
    $('#complain-form').submit(function(e) {
      e.preventDefault();
      $.ajax({
        url: BASE_URL + 'task/non/complain/store',
        type: "POST",
          ...
          if (response.queryResult == true) {
            if (!is_close) {
              ...
              Swal.fire({
                ...
                $('.samrs-table1').DataTable().ajax.reload();
                document.location.href = "<?php echo base_url(); ?>task/non/complain";
              });
