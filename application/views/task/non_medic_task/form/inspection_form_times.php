<div id="inspection_times" class="modal samrs-modal zoom fade" data-backdrop="static" role="dialog">
  <div class="modal-dialog modal-xl">
    <form id="inp-formtimes">
      <div class="modal-content">
        <div class="modal-header">
          <p>Edit inspection</p>
          <a href="<?= base_url('task/non/inspection/schedule_report'); ?>" class="btn btn-rounded btn-outline-danger" class="close" aria-hidden="true">×</a>
        </div>
...
<script>
  $(document).ready(function() {
    ...
    $('#inp-formtimes').submit(function(e) {
      e.preventDefault();
      $.ajax({
        url: BASE_URL + 'task/non/inspection/schedule_report/store_form_schedule_edit',
        type: "POST",
