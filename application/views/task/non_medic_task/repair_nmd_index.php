<main dir="ltr" class="page-wrapper full-height" id="App">
  <main-app>
    ...
    <action-button-card title="Non Electromedic Task - Repair">
      <template v-slot:buttons>
        <table-init></table-init>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][5]['subMenu3'][0]['isAllow'] == true) : ?>
          <approve-data button-id="modal_approve_repair"></approve-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][5]['subMenu3'][1]['isAllow'] == true) : ?>
          <add-data modal="repair_form"></add-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][5]['subMenu3'][2]['isAllow'] == true) : ?>
          <edit-data button-id="modal_edit_repair" text="Finish/Pending"></edit-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][5]['subMenu3'][3]['isAllow'] == true) : ?>
          <delete-data button-id="modal_delete_repair"></delete-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][5]['subMenu3'][4]['isAllow'] == true) : ?>
          <detail-data button-id="modal_detail_repair"></detail-data>
        <?php endif; ?>

        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][5]['subMenu3'][5]['isAllow'] == true) : ?>
          <print-data modal="task_print"></print-data>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][5]['subMenu3'][6]['isAllow'] == true) : ?>
          <table-advance-search overlay="advanced_search"></table-advance-search>
        <?php endif; ?>
        <?php if ($result_role[2]['subMenu1'][1]['subMenu2'][5]['subMenu3'][7]['isAllow'] == true) : ?>
  ...
  function detail() {
    $("#modal_detail_repair").click(function() {
      ...
      if (idTask.length == 1) {
        $.ajax({
          type: "POST",
          url: BASE_URL + "task/non/complain/complain_by_id",
          data: {
            idTask: idTask
          },
          dataType: "json",
