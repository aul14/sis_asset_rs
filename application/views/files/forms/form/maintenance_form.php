<div id="maintenance_form" class="modal samrs-modal zoom fade" data-backdrop="static" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <form action="<?= base_url('files/forms/maintenance/store'); ?>" method="post" id="addform">
      <div class="modal-content">
        <div class="modal-header">
          <p id="title-forms-main">add new form maintenance</p>
        ...
        <div class="modal-body fixed-height samrs-form" id="app_form">
          ...
          <form-main>
            <template v-slot:ftname-form>
              <input class="form-control" name="ftName_hc" type="text" id="ftName_hc" value="Maintenance Forms" required readonly>
            </template>
          </form-main>
...
<script>
  function clickback() {
    "<?php
      ...
      ?>"
    document.location.href = "<?php echo base_url(); ?>files/forms/maintenance";
  }
  $(function() {
    var is_close = false;
