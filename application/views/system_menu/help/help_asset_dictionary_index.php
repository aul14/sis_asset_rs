...
<script>
  let table = $('.samrs-table1').DataTable({
    ...
    columns: [{
      ...
      {
        title: 'Asset Name Aspak',
        name: 'Asset Name Aspak'
      },
      {
        title: 'UMDNS',
        name: 'UMDNS'
      ...
      {
        title: 'Calibration Service Price',
        name: 'Calibration Service Price'
      },
      {
        title: 'Repair KPI Poin',
        name: 'Repair KPI Poin'
      },
      {
        title: 'Repair Service Price',
        name: 'Repair Service Price'
      },
      {
        title: 'Maintenance KPI Poin',
        name: 'Maintenance KPI Poin'
      },
      {
        title: 'Maintenance Service Price',
        name: 'Maintenance Service Price'
      },
      {
        title: 'Inspection KPI Poin',
        name: 'Inspection KPI Poin'
      },
      {
        title: 'Inspection Service Price',
        name: 'Inspection Service Price'
      },
    ],
