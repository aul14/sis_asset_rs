...
class Schedule_report extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($result_role[2]['subMenu1'][1]['subMenu2'][1]['subMenu3'][0]['isAllow'] != true) {
            exit('You dont have access!!');
        }

        $this->load->view('components/header');
        $this->load->view('components/sidebar', $data);
        $this->load->view('task/non_medic_task/print/inspection/task_print');
        $this->load->view('task/non_medic_task/form/inspection_form');
        $this->load->view('task/non_medic_task/form/inspection_form_edit');
        $this->load->view('task/non_medic_task/form/inspection_form_times');
        $this->load->view('task/non_medic_task/inspection_schedule_nmd_report');
