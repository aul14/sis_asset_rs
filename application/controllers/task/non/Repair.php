...
class Repair extends CI_Controller
{
  ...
  public function index()
  {
    ...
    if ($result_role[2]['subMenu1'][1]['subMenu2'][5]['isAllow'] != true) {
      exit('You dont have access!!');
    }

    $this->load->view('components/header');
    $this->load->view('components/sidebar', $data);
    $this->load->view('task/non_medic_task/form/repair_form');
    $this->load->view('task/non_medic_task/repair_nmd_index');
    $this->load->view('task/non_medic_task/details/complain_repair_details');
    $this->load->view('task/non_medic_task/print/repair/task_print');
