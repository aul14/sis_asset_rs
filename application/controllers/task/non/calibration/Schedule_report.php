...
class Schedule_report extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($result_role[2]['subMenu1'][1]['subMenu2'][0]['subMenu3'][0]['isAllow'] != true) {
            exit('You dont have access!!');
        }

        $this->load->view('components/header');
        $this->load->view('components/sidebar', $data);
        $this->load->view('task/non_medic_task/calibration_schedule_nmd_report');
        $this->load->view('task/non_medic_task/form/calibration_form', $data);
        $this->load->view('task/non_medic_task/print/calibration/task_print');
    ...
    public function update_action()
    {
        ...
        die;
        // redirect('task/non/calibration/schedule_report', 'refresh');
    }
