...
class Complain extends CI_Controller
{
  ...
  public function index()
  {
    ...
    if ($result_role[2]['subMenu1'][1]['subMenu2'][4]['isAllow'] != true) {
      exit('You dont have access!!');
    }

    $this->load->view('components/header');
    $this->load->view('components/sidebar', $data);
    $this->load->view('task/non_medic_task/form/complain_form');
    $this->load->view('task/non_medic_task/form/repair_form_directTo');
    $this->load->view('task/non_medic_task/complain_nmd_index');
    $this->load->view('task/non_medic_task/print/complain/task_print');
    $this->load->view('task/non_medic_task/details/complain_repair_details');
    $this->load->view('task/non_medic_task/approve/complain_repair_approve');
