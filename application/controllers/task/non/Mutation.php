...
class Mutation extends CI_Controller
{
  ...
  public function index()
  {
    ...
    if ($result_role[2]['subMenu1'][1]['subMenu2'][3]['isAllow'] != true) {
      exit('You dont have access!!');
    }

    $this->load->view('components/header');
    $this->load->view('components/sidebar', $data);
    $this->load->view('task/non_medic_task/form/mutation_form');
    $this->load->view('task/non_medic_task/approve/mutation_approve');
    $this->load->view('task/non_medic_task/return/mutation_return');
    $this->load->view('task/non_medic_task/confirm/mutation_confirm');
    $this->load->view('task/non_medic_task/mutation_nmd_index');
  ...
  public function store()
  {
    ...
    redirect('task/non/mutation', 'refresh');
  }
