...
class Schedule_report extends CI_Controller
{
  ...
  public function index()
  {
    ...
    if ($result_role[2]['subMenu1'][0]['subMenu2'][2]['subMenu3'][0]['isAllow'] != true) {
    ...
    $this->load->view('task/electromedic_task/print/maintenance/task_print');
    $this->load->view('task/electromedic_task/form/maintenance_form');
    $this->load->view('task/electromedic_task/form/maintenance_form_report');
    $this->load->view('task/electromedic_task/form/maintenance_form_times');
    $this->load->view('task/electromedic_task/maintenance_schedule_med_report');
  ...
  public function store_form_edit()
  {
    ...
    // redirect('task/med/maintenance/schedule_report', 'refresh');
  }
