...
class Sparepart_data_table extends CI_Controller
{
    ...
    public function view_data_table()
    {
        ...
        if (sizeof($posts) > 0) {
            ...
            foreach ($posts['data'] as $key => $value) {
                ...
                $posts['data'][$key]['propAssetPropadmin']['priceBuy'] = number_format($value['propAssetPropadmin']['priceBuy'], 0, ',', '.');
                ...
                if ($value['propAssetPropstock']) {
                    foreach ($value['propAssetPropstock'] as $key2 => $val) {
                        $posts['data'][$key]['propAssetPropstock']['qtyCurrent'] =  $val['qtyCurrent'];
                        $posts['data'][$key]['propAssetPropstock']['qtyMin'] =  $val['qtyMin'];
                    }
                } else {
                    $posts['data'][$key]['propAssetPropstock']['qtyCurrent'] =  0;
                    $posts['data'][$key]['propAssetPropstock']['qtyMin'] = 0;
                }
...
/* End of file Sparepart_data_table.php */
