...
class Sparepart_med extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($result_role[1]['subMenu1'][0]['subMenu2'][1]['isAllow'] != true) {
            exit('You dont have access!!');
        }

        $this->load->view('components/header');
        $this->load->view('components/sidebar', $data);
        $this->load->view('assets/medical_equipment/sparepart_med_index', $data);
        $this->load->view('assets/medical_equipment/form/sparepart_form');
        $this->load->view('assets/medical_equipment/details/inventory_details');
        $this->load->view('assets/medical_equipment/print/parts/assets_print_med');
    ...
    public function ajax_room_warehouse()
    {
        if (!$this->input->is_ajax_request()) {
            exit('No direct script access allowed');
        }

        $result = $this->m_asset_propbuilding_room->assetPropBuildingRoomByIsWarehouse("true");
        echo json_encode($result['data']);
        exit;
    }
