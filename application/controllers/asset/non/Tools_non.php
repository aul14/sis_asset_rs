...
class Tools_non extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($result_role[1]['subMenu1'][1]['subMenu2'][2]['isAllow'] != true) {
            exit('You dont have access!!');
        }

        $this->load->view('components/header');
        $this->load->view('components/sidebar', $data);
        $this->load->view('assets/non_medical_equipment/tools_non_index', $data);
        $this->load->view('assets/non_medical_equipment/form/tools_form');
    ...
    public function store()
    {
        ...
        if (!empty($input['idAsset'])) {
            ...
            // redirect('asset/non/tools_non', 'refresh');
