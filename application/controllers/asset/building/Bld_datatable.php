...
class Bld_datatable extends CI_Controller
{
    ...
    public function bld_data_table()
    {
        ...
        if (sizeof($posts) > 0) {
            ...
            foreach ($posts['data'] as $key => $value) {
                ...
                $posts['data'][$key]['flourAmount'] = sizeof($value['propAssetPropbuilding']['propAssetPropbuildingFloor']);
...
/* End of file Bld_controller.php */
